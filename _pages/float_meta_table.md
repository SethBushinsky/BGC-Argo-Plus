...
$(document).ready(function(){
  ...
  setTimeout(function(){
    ...
    $('#export-csv').on('click', function() {
      ...
      // Add header row - dynamically generated from DataFrame columns
      var headers = ['WMO', 'Project', 'Deployment_Date', 'Dep_Lat', 'Dep_Lon', 'Last_Date', 'Profiles', 'BGC Variables', 'Ocean Basin'];
      ...
      filteredData.each(function(rowData) {
        ...
        row.push('"' + wmo + '"');
        // Loop over remaining columns dynamically
