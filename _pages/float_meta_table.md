...
<table id="my-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Argo Australia</td>
      <td>2024-12-29T01:14</td>
      <td>-38.772</td>
      <td>116.909</td>
      <td>2025-01-08T20:28</td>
      <td>8</td>
      <td>PRES TEMP PSAL BBP700 CHLA PH_IN_SITU_TOTAL NITRATE DOXY</td>
    </tr>
    <tr>
      <td><a href="https://www.bgc-argo-plus.info/float_pages/5905634/">5905634</a></td>
      <td>UW, SOCCOM, Argo equivalent</td>
      <td>2018-03-22T09:52</td>
      <td>nan</td>
      <td>nan</td>
    ...
    <tr>
      ...
      <td>UW, Argo</td>
      <td>2021-07-08T15:57</td>
      <td>39.925</td>
      <td>-125.139</td>
      <td>2022-12-26T22:34</td>
      <td>128</td>
      <td>PRES TEMP PSAL DOWN_IRRADIANCE380 DOWN_IRRADIANCE412 DOWN_IRRADIANCE490 DOWNWELLING_PAR</td>
    </tr>
    <tr>
      <td><a href="https://www.bgc-argo-plus.info/float_pages/5906448/">5906448</a></td>
      <td>UW, GO-BGC</td>
      <td>2021-10-20T22:49</td>
      <td>-17.476</td>
      <td>-113.188</td>
    ...
    <tr>
      ...
      <td>remOcean</td>
      <td>2013-06-16T23:06</td>
      <td>62.7575</td>
      <td>-30.2809</td>
      <td>2017-05-16T14:47</td>
      <td>382</td>
      <td>PRES TEMP PSAL DOWN_IRRADIANCE380 DOWN_IRRADIANCE412 DOWN_IRRADIANCE490 DOWNWELLING_PAR CHLA CHLA_FLUORESCENCE BBP700 CDOM</td>
    </tr>
    <tr>
      <td><a href="https://www.bgc-argo-plus.info/float_pages/6901481/">6901481</a></td>
      <td>remOcean</td>
      <td>2013-06-17T01:09</td>
      <td>62.7587</td>
      <td>-30.2659</td>
    ...
    <tr>
      ...
      <td>Argo GERMANY</td>
      <td>2021-03-27T15:42</td>
      <td>57.2715</td>
      <td>20.007</td>
      <td>2022-03-08T12:12</td>
      <td>150</td>
      <td>PRES TEMP PSAL DOXY CHLA CHLA_FLUORESCENCE BBP700 CDOM</td>
    </tr>
    <tr>
      <td><a href="https://www.bgc-argo-plus.info/float_pages/7900587/">7900587</a></td>
      <td>Argo GERMANY</td>
      <td>2021-03-27T14:02</td>
      <td>57.3967</td>
      <td>19.9601</td>
    ...
    <tr>
      ...
      <td>Argo GERMANY</td>
      <td>2021-07-31T14:39</td>
      <td>50.2851</td>
      <td>-38.5722</td>
      <td>2024-12-01T12:00</td>
      <td>294</td>
      <td>PRES TEMP PSAL CHLA CHLA_FLUORESCENCE BBP700 CDOM</td>
    </tr>
    <tr>
      <td><a href="https://www.bgc-argo-plus.info/float_pages/7900589/">7900589</a></td>
      <td>Argo GERMANY</td>
      <td>2021-08-17T16:54</td>
      <td>57.0249</td>
      <td>-50.2599</td>
...
<div style="margin-top: 20px;">
  <button id="export-csv" class="btn btn-primary" style="background-color: #007cba; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer;">
    📥 Download Filtered Results as CSV
  </button>
  <span id="export-status" style="margin-left: 10px; font-style: italic; color: #666;"></span>
</div>
...
$(document).ready(function(){
  ...
  setTimeout(function(){
    ...
    $('#export-csv').on('click', function() {
      var statusSpan = $('#export-status');
      statusSpan.text('Preparing CSV...');
      
      // Get filtered data from DataTables
      var filteredData = table.rows({ search: 'applied' }).data();
      
      if (filteredData.length === 0) {
        statusSpan.text('No data to export.').css('color', '#d73527');
      ...
      // Add header row
      var headers = ['WMO', 'Project', 'Deployment_Date', 'Dep_Lat', 'Dep_Lon', 'Last_Date', 'Profiles', 'BGC Variables'];
      csvContent.push(headers.map(header => '"' + header + '"').join(','));
      
      // Add data rows
      filteredData.each(function(rowData) {
        var row = [];
        // Extract WMO from the link (first cell contains <a> tag)
        var wmoMatch = rowData[0].match(/>(\d+)</);
        var wmo = wmoMatch ? wmoMatch[1] : rowData[0];
      ...
      // Get current search term for filename
      var searchTerm = table.search();
      var filename = 'bgc_argo_floats';
      if (searchTerm) {
        filename += '_filtered_' + searchTerm.replace(/[^a-zA-Z0-9]/g, '');
      }
      filename += '.csv';
      ...
      statusSpan.text('Downloaded ' + filteredData.length + ' records').css('color', '#28a745');
      setTimeout(function() { statusSpan.text(''); }, 3000);
    });
